...
$(document).ready(function() {
    ...
    if (!m) {
        ...
        $(".wrapper").mouseup(function(e) {
            var s = $(".quick-sidebar");
            e.target.className == s.attr("class") || s.has(e.target).length || ($("html").removeClass("quick_sidebar_open"),
    ...
    if (!d) {
        ...
        w.on("click", function() {
            1 == v ? ($("html").removeClass("topbar_open"),
            w.removeClass("toggled"),
            v = 0) : ($("html").addClass("topbar_open"),
            w.addClass("toggled"),
            v = 1)
        }),
        d = !0
    ...
    if (!g) {
        ...
        $(".wrapper").hasClass("sidebar_minimize") && (_.addClass("toggled"),
        _.html('<i class="gg-more-vertical-alt"></i>'),
        f = 1),
        _.on("click", function() {
            1 == f ? ($(".wrapper").removeClass("sidebar_minimize"),
            _.removeClass("toggled"),
            _.html('<i class="gg-menu-right"></i>'),
            f = 0) : ($(".wrapper").addClass("sidebar_minimize"),
            _.addClass("toggled"),
            _.html('<i class="gg-more-vertical-alt"></i>'),
            f = 1),
            $(window).resize()
    ...
    if (!p) {
        ...
        q.on("click", function() {
            1 == b ? ($("html").removeClass("pagesidebar_open"),
            q.removeClass("toggled"),
            b = 0) : ($("html").addClass("pagesidebar_open"),
            q.addClass("toggled"),
            b = 1)
        }),
    ...
    $(".wrapper").hasClass("is-show") && (C = 1,
    y.addClass("toggled"),
    y.html('<i class="icon-options-vertical"></i>')),
    y.on("click", function() {
        1 == C ? ($(".wrapper").removeClass("is-show"),
        y.removeClass("toggled"),
        y.html('<i class="icon-menu"></i>'),
        C = 0) : ($(".wrapper").addClass("is-show"),
        y.addClass("toggled"),
        y.html('<i class="icon-options-vertical"></i>'),
        C = 1),
        $(window).resize()
    ...
    $(".sidebar").mouseenter(function() {
        1 != f || u ? $(".wrapper").removeClass("sidebar_minimize_hover") : ($(".wrapper").addClass("sidebar_minimize_hover"),
        u = !0)
    }).mouseleave(function() {
        1 == f && u && ($(".wrapper").removeClass("sidebar_minimize_hover"),
        u = !1)
    }),
...
function changeContainer() {
    !0 == showSignIn ? containerSignIn.css("display", "block") : containerSignIn.css("display", "none"),
    !0 == showSignUp ? containerSignUp.css("display", "block") : containerSignUp.css("display", "none")
}
